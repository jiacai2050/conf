...
(use-package elfeed
  ...
  (setq elfeed-search-filter "@6-months-ago +unread #50"
        elfeed-feeds '(("https://blog.yugabyte.com/feed/" db company)
                       ("https://www.cockroachlabs.com/blog/index.xml" db company)
                       ("https://feeds.feedburner.com/ruanyifeng" blog)
                       ("https://www.raychase.net/feed" blog)
                       ("https://jherrlin.github.io/index.xml" emacs)
